<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/scie.Master" CodeBehind="maincrop2.aspx.vb" Inherits="CIS.maincrop2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 <br /><br />
<center><asp:DetailsView runat="server"  Height="100px" Width="800px" AllowPaging="True" AutoGenerateRows="False" DataSourceID="SqlDataSource1" CellPadding="4" ForeColor="#333333" GridLines="None" >
    ...
    <Fields>
        ...
        <asp:BoundField DataField="origin" HeaderText="ઓરીજીન" SortExpression="origin" />
        <asp:BoundField DataField="seed_rate" HeaderText="બીયારણનો દર" SortExpression="seed_rate" />
        ...
        <asp:BoundField DataField="yield" HeaderText="ઉપજ" SortExpression="yield" />
